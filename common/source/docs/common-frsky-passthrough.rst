...
The ArduPilot passthrough telemetry specification including data packets and message rates is available as a `spreadsheet <../../../images/FrSky_Passthrough_protocol.xlsx>`__.
